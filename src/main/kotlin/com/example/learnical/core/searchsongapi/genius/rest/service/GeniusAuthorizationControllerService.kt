...
interface GeniusAuthorizationControllerService {
     ...
     * */
    fun storeAuthorizationToken(user: User, jwtToken : GeniusAuthorizationController.GeniusJWT)

    /**
     * return current stored jwt token for the given user.
     * return null if non token is currently stored
     * */
    fun retrieveAuthorizationToken(user : User) : GeniusAuthorizationController.GeniusJWT?
}